...
release: clean build
	mkdir -p releases
	tar caf releases/$(name)-$(version)-$(target).tar.xz bin/chrome-shell extra/man/chrome-shell.1.gz extra/shell-completion/chrome-shell.bash extra/shell-completion/chrome-shell.zsh extra/shell-completion/chrome-shell.fish extra/shell-completion/chrome-shell-completions.nu docs samples
...
uninstall:
	rm -f $(DESTDIR)$(PREFIX)/bin/chrome-shell $(DESTDIR)$(PREFIX)/share/man/man1/chrome-shell.1.gz $(DESTDIR)$(PREFIX)/share/bash-completion/completions/chrome-shell.bash $(DESTDIR)$(PREFIX)/share/zsh/site-functions/_chrome-shell $(DESTDIR)$(PREFIX)/share/fish/vendor_completions.d/chrome-shell.fish $(DESTDIR)$(PREFIX)/share/nushell/vendor/autoload/chrome-shell-completions.nu
